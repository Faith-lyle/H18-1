...
class Application(Frame):
    ...
    def auto_choose_port(self):
        ...
        if len(self.ports) == 0:
            ...
            try:
                ...
                port1 = port[:i - 1]
                # print(port1)
                self.term = SerialPort(PortName=port1, BaudRate=921600, TimeOut=1.5)
    ...
    def showlog_widght(self, master):
        ...
        L4 = Label(master, text='Contact:Lyle.Hou@luxshare-ict.com  version:3.3  ', bg='#6A5ACD', fg='white',
                   anchor='w', font=('黑体', 12))
    ...
    def begin1(self):
        ...
        if self.term != None:
            try:
                ...
                # Open Tunnel Test
                try:
                    text += self.term.send_read(cmd='[ttim-02]',terminator='<',nextline_check=False)
                ...
                try:
                    ...
                    value3 = self.term.read_until(terminator='syscfg:ok ',nextline_check=True,timeout=1.5)
                    text += value3
...
if __name__ == '__main__':
    ...
    window = Tk()
    window.title('Golden Finger TestV3.3')
